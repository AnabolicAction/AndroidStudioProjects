...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void showCurrentLocation(Location location) {
        ...
        LatLng m1 = new LatLng(37.4740619,127.0493868);
        mMap.addMarker(new MarkerOptions().position(m1).title("Matzip").icon(BitmapDescriptorFactory.fromResource(R.drawable.image1)));
        LatLng m2 = new LatLng(37.4760619,127.0473868);
        mMap.addMarker(new MarkerOptions().position(m2).title("PCBang").icon(BitmapDescriptorFactory.fromResource(R.drawable.image1)));
